...
func TestLTO_CreateAccount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			lto, err := Client().WithNetwork(tt.fields.Network).New()
...
func TestLTO_CreateAccountFromExistingPhrase(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := lto.Account().FromSeed(tt.args.Seed).New()
...
func TestLTO_CreateAccountFromPrivateKey(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := lto.Account().FromPrivateKey(tt.args.privateKey).New()
			if (err != nil) != tt.wantErr {
